                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <select class="form-select form-control-solid @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                            ...
                                            <option value="BOI" @if(old('bank_name') == 'BRI')selected="selected"@endif>BOI</option>
                                            <option value="HDFC" @if(old('bank_name') == 'BNI')selected="selected"@endif>HDFC</option>
                                            <option value="SBI" @if(old('bank_name') == 'BCA')selected="selected"@endif>SBI</option>
                                        </select>
