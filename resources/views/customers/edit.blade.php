                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            <select class="form-select @error('bank_name') is-invalid @enderror"
                                                ...
                                                <option value="BOI"
                                                    @if (old('bank_name', $customer->bank_name) == 'BOI') selected="selected" @endif>BOI
                                                </option>
                                                <option value="HDFC"
                                                    @if (old('bank_name', $customer->bank_name) == 'HDFC') selected="selected" @endif>HDFC
                                                </option>
                                                <option value="SBI"
                                                    @if (old('bank_name', $customer->bank_name) == 'SBI') selected="selected" @endif>SBI
                                                </option>
                                            </select>
