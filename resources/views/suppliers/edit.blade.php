                    ...
                    <div class="col-lg-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <img class="img-account-profile mb-2" src="{{ asset($supplier->photo) }}" alt="" id="image-preview" />
                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-sm-6 col-md-6">
                                        ...
                                        <select class="form-select @error('bank_name') is-invalid @enderror" id="bank_name" name="bank_name">
                                            ...
                                            <option value="BOI" @if(old('bank_name', $supplier->bank_name) == 'BOI')selected="selected"@endif>BOI</option>
                                            <option value="HDFC" @if(old('bank_name', $supplier->bank_name) == 'HDFC')selected="selected"@endif>HDFC</option>
                                            <option value="SBI" @if(old('bank_name', $supplier->bank_name) == 'SBI')selected="selected"@endif>SBI</option>
                                        </select>
